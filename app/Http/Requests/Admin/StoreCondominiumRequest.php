...
class StoreCondominiumRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'excerpt' => ['nullable', 'string', 'max:'.self::SHORT_SUMMARY_LIMIT], 'description' => ['nullable', 'string'], 'address' => ['nullable', 'string', 'max:255'], 'neighborhood' => ['nullable', 'string', 'max:255'], 'postal_code' => ['nullable', 'string', 'max:12'],
