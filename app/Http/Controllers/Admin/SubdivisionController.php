...
class SubdivisionController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Subdivisions/Form', ['item' => $subdivision->load(['city.state', 'features.iconMedia', 'mediaAssets', 'promotions.mediaAsset', 'constructionStages', 'documents.mediaAsset', 'seo']), 'options' => $this->options()]);
    }
