...
class SubdivisionController extends Controller
{
    ...
    public function show(Subdivision $subdivision): Response
    {
        ...
        $subdivision->load(['city.state', 'subdivisionType', 'developmentStatus', 'features.iconMedia', 'mediaAssets', 'aboutMedia', 'promotionMedia', 'promotions.mediaAsset', 'constructionStages.mediaAssets', 'constructionProgressUpdates.mediaAssets', 'seo']);
