...
class StorePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'development_status_id' => ['nullable', 'exists:development_statuses,id'], 'city_id' => ['nullable', 'exists:cities,id'],
            ...
            'furnished' => ['boolean'], 'accepts_financing' => ['boolean'], 'accepts_exchange' => ['boolean'], 'is_new' => ['boolean'], 'commercial_purpose' => ['required', Rule::in(['sale', 'rent'])], 'commercial_status' => ['nullable', 'string', 'max:30'], 'status' => ['required', Rule::in(['draft', 'published', 'archived'])],
