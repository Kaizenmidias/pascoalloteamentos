...
trait HasRealEstateContentRules
{
    protected function contentRules(): array
    {
        ...
        return [
            ...
            'construction_stages.*.photos.*' => ['file', 'mimetypes:image/jpeg,image/png,image/webp,image/heic,image/heif,image/heic-sequence,image/heif-sequence,video/mp4,video/webm,video/quicktime', 'max:524288'],
            ...
            'progress_updates.*.photos' => ['nullable', 'array', 'max:15'],
            'progress_updates.*.photos.*' => ['file', 'mimetypes:image/jpeg,image/png,image/webp,image/heic,image/heif,image/heic-sequence,image/heif-sequence,video/mp4,video/webm,video/quicktime', 'max:524288'],
