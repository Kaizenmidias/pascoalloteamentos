...
const Hero = ({ contact = false }) => (
    <section className="relative flex min-h-[620px] items-center overflow-hidden px-5 pt-[80px] text-center text-white">
        ...
        <>
            ...
            <section className="bg-surface py-16 text-center">
                <Container>
                    ...
                    <Link href="/imoveis" className="brand-button mt-6">Conheça nossos empreendimentos</Link>
                </Container>
            </section>
        </>
    );
