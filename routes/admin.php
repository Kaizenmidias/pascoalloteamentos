...
Route::middleware(['auth', 'can:access-admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('can:admin-only')->group(function () {
        ...
        Route::delete('condominiums/{condominium}', [CondominiumController::class, 'destroy'])->name('condominiums.destroy');
        Route::delete('subdivisions/{subdivision}', [SubdivisionController::class, 'destroy'])->name('subdivisions.destroy');
        Route::delete('blog/posts/{post}', [CmsController::class, 'destroyPost'])->name('blog.posts.destroy');
