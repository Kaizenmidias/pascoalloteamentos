...
class CondominiumController extends Controller
{
    ...
    public function show(Condominium $condominium): Response
    {
        ...
        $condominium->load(['city.state', 'condominiumType', 'developmentStatus', 'properties', 'features.iconMedia', 'mediaAssets', 'aboutMedia', 'promotionMedia', 'floorPlans.mediaAsset', 'promotions.mediaAsset', 'constructionStages.mediaAssets', 'constructionProgressUpdates.mediaAssets', 'seo']);
