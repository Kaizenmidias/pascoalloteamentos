...
const whatsappUrl = (item, fallback) => { const phone = String(item.whatsapp_contact || fallback || '').replace(/\D/g, ''); return phone ? `https://wa.me/${phone}?text=${encodeURIComponent(`Olá, tenho interesse no imóvel ${item.title}.`)}` : null; };
