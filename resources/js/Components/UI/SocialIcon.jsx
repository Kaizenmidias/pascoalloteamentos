const icons = {
    ...
    email: <path className="stroke-current fill-none" d="M4 6.5h16a1.5 1.5 0 0 1 1.5 1.5v8a1.5 1.5 0 0 1-1.5 1.5H4A1.5 1.5 0 0 1 2.5 16V8A1.5 1.5 0 0 1 4 6.5Zm0 1.5v.3l8 5.3 8-5.3V8H4Zm16 8V10.2l-7.1 4.7a1.5 1.5 0 0 1-1.8 0L4 10.2V16h16Z" />,
};
