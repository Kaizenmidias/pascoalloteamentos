    ...
    private function defaultSectionsFor(string $slug): array
    {
        return match ($slug) {
            ...
            'contato' => [
                ...
                ['type' => 'contact-form', 'data' => ['label' => 'FormulÃƒÂ¡rio', 'title' => 'Fale com Nossa Equipe', 'subtitle' => 'Estamos disponÃƒÂ­veis para atender vocÃƒÂª.', 'content' => 'Preencha o formulÃƒÂ¡rio e nossa equipe entrarÃƒÂ¡ em contato o mais breve possÃƒÂ­vel.', 'button_label' => 'Enviar mensagem', 'recipient_email' => 'contato@pascoalloteamentos.com.br']],
