...
export default function ContentManager({ data, setData, item, showPlans = true, showPlansTitle = false, errors = {}, showStages = true, showSpecialImages = true, showFaqs = true, showDocuments = true, showFeaturedUpload = false, showSeo = true, showPromotions = true, showGallery = true }) {
